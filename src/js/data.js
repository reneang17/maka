export const instructorsData = {
    'maria': {
        ...
        quote_en: 'May our practice and community become<br>An open space. A loving shelter.<br>A place to move the body, breathe deep, and build community.<br>A shared practice, so we don\'t keep carrying alone what hurts in common.',
    ...
    'alosja': {
        ...
        quote_en: 'Community is the firm foundation upon which we build our personal practice; it is the reminder that we are mirrors of each other.',
        ...
        classDesc_en: 'A paced and structured practice, focused on correct alignment, the use of props to adapt the posture to the body, and the integration of pranayama (breathing).',
        phone: '529513464383'
    },
    'phan': {
        name: 'Phan',
    ...
    'karina': {
        ...
        quote: 'La disciplina no es rigidez, es el fuego que compartimos para mantenernos cálidos. Sostener comunidad es motivarnos a volver al tapete día tras día.',
        quote_en: 'Discipline is not rigidity, it is the fire we share to keep ourselves warm. Holding community is motivating us to return to the mat day after day.',
