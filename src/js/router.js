export function initRouter() {
    ...
    const validPages = ['home', 'space', 'vision', 'schedule', 'team', 'contact', 'testimonios', 'instructor-alosja', 'instructor-maria', 'instructor-karina', 'instructor-phan', 'instructor-andres'];
...
export function navigateTo(pageId, sectionId = null, pushState = true) {
    const pages = ['home', 'space', 'vision', 'schedule', 'team', 'contact', 'testimonios', 'instructor-alosja', 'instructor-maria', 'instructor-karina', 'instructor-phan', 'instructor-andres'];
